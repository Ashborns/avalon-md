...
const kei = 'AIzaSyAyimkuYQYF_FXVALexPuGQctUWRURdCYQ'
...
let handler = async (m, { conn, text, usedPrefix, command }) => {
	...
	const res = await fetch(`https://tenor.googleapis.com/v2/featured?key=${kei}&contentfilter=high&media_filter=png_transparent&component=proactive&collection=emoji_kitchen_v5&q=${encodeURIComponent(l)}_${encodeURIComponent(r)}`)
